...
const addToPackButtons = document.querySelectorAll(".add-to-pack> button");
...
function addToPacket(id) {
  ...
  updateCartSize();
  notification("Product added to packet");
}
...
function updateCartSize() {
  ...
  document.querySelector("#box p").innerText = totalQuantity;
}
...
function removeFromCart(id, productContainer) {
  ...
  updateCartSize();
  notification("Product removed from Packet");
}
